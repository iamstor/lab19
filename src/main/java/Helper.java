...
public class Helper {
    ...
    public static void remove_greater(HashSet<Character> characters,String name) {
        ...
        map = (LinkedTreeMap<String, Object>) gson.fromJson(name, type);
        ...
        if (map.containsKey("name")) {
            ...
            for (Character current : characters) {
                if (current.name.toLowerCase().compareTo(addingName.toLowerCase())<0) {
    ...
    public static void remove(HashSet<Character> characters, String name) {
        ...
        if (map.containsKey("name")) {
            ...
            for (Character ch : characters) {
                if (ch.getName().toLowerCase().equals(addingName.toLowerCase())) {
    ...
    public static void add(HashSet<Character> characters, String json) {
        ...
        try {
            ...
            if (canAdd) {
                ...
                System.out.println("Нельзя добавлять персонажей  с одинаковыми именами ");
            }
        }catch (Exception e) {
            System.err.println("Возникла ошибка при добавлении персонажа, возможно вы ввели неверно вашу json строку");
        }
    }
